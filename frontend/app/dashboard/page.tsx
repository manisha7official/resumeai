  ...
  return (
    <div style={{minHeight:'100vh',background:'#f8fafc',fontFamily:'sans-serif'}}>
      <div style={{background:'white',borderBottom:'1px solid #e2e8f0',padding:'16px 32px',display:'flex',alignItems:'center',gap:'12px'}}>
        ...
        <span style={{marginLeft:'auto',fontSize:'13px',color:'#94a3b8'}}>Powered by LLaMA 3.3</span>
      </div>
      ...
      <div style={{maxWidth:'1100px',margin:'0 auto',padding:'32px 16px'}}>
        ...
        <div style={{textAlign:'center',marginBottom:'32px'}}>
          ...
          {loading && <div style={{marginTop:'12px',fontSize:'13px',color:'#94a3b8'}}>This takes 5-10 seconds...</div>}
        </div>
          ...
          <div>
            ...
            <div style={{background:'white',borderRadius:'16px',border:'1px solid #e2e8f0',overflow:'hidden'}}>
              ...
              <div style={{padding:'24px'}}>
                ...
                {tab === 'bullets' && (
                  <div>
                    <p style={{fontSize:'13px',color:'#94a3b8',marginBottom:'16px'}}>AI rewrote your weakest bullets using STAR format 👇</p>
                    {result.rewritten_bullets?.map((b:{original:string;improved:string}, i:number) => (
